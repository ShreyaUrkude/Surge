                                    ...
                                    <div className={styles.productCard}>
                                        ...
                                        <div className={`${styles.details} ${!item.tagline ? styles.detailsSpaced : ''}`}>
                                            ...
                                            <div className={styles.footerRow}>
                                                <span className={styles.priceTag}>AED {rawPrice}.00</span>
                                                <AddToCart product={{ productId: item.id, name: item.name, image: imageUrl, quantity: 1, variationId: item.variants?.[0]?.id || null }} />
                                            </div>
                                        </div>
                                    </div>
                                </Link>
